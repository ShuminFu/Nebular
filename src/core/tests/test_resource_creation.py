...
from src.nebular_core.task_utils import TaskType, TaskStatus, BotTask
...
from src.nebular_core.tests.test_task_utils import AsyncTestCase, TaskPriority
        ...
        task = BotTask(
            ...
            parameters={
                ...
                'code_details': {
                    ...
                    'frameworks': ['normalize.css', '@popperjs/nebular_core'],
                    'resources': [
                        {
