...
graph TD
    ...
    classDef hardCoded fill:#FF5555,stroke:#FF5555,color:#fff
    ...
    subgraph Agent["Agent进程"]
        ...
        subgraph OperaConnector["Opera连接器详情"]
            CM[Context Manager] -->|获取上下文| IA[Intention Agent]
            IA -->|任务分析| PC[Preset Crew]
            PC -->|可选| CC[Crew Creator]
            CC --> MM[Mailman]
            PC --> MM
        end
